...
class WardrobeItem(Base):
    ...
    @classmethod
    def save_item_to_wardrobe(cls, db, current_user, final_path, resolved_category, resolved_color, resolved_style, resolved_occasion, name: str = None):
...
class Wardrobe(Base):
    ...
    # 這個方法應該在 WardrobeItem 中，這裡為了相容性暫時保留或移除
    # def save_item_to_wardrobe(...)